...
export class CoreHUD {
  ...
  get itemButtons(): ItemButtonType[]
  ...
  addItemButtons(items: ItemButtonType | ItemButtonType[]): void
...
import { ItemPF2e } from "types/pf2e/src/module/item/index.js"
