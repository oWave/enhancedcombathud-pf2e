import { ArmyPF2e, CharacterPF2e, FamiliarPF2e, HazardPF2e, LootPF2e, NPCPF2e, PartyPF2e, VehiclePF2e } from "types/pf2e/src/module/actor/index.ts"
import { ActorType } from "types/pf2e/src/module/actor/data/index.ts"
import { AbilityItemPF2e, AfflictionPF2e, AncestryPF2e, ArmorPF2e, BackgroundPF2e, BookPF2e, CampaignFeaturePF2e, ClassPF2e, ConditionPF2e, ConsumablePF2e, ContainerPF2e, DeityPF2e, EffectPF2e, EquipmentPF2e, FeatPF2e, HeritagePF2e, KitPF2e, LorePF2e, MeleePF2e, SpellPF2e, SpellcastingEntryPF2e, TreasurePF2e, WeaponPF2e } from "types/pf2e/src/module/item/index.ts"
import { WeaponReloadTime } from "types/pf2e/src/module/item/weapon/types.ts"
import { JournalSheetPF2e } from "types/pf2e/src/module/journal-entry/sheet.ts"
...
export declare const PF2ECONFIG: {
    ...
    otherWeaponTags: Record<import("src/module/item/weapon/types.ts").OtherWeaponTag, string>;
    armorTraits: {
        adjusted: string;
        alchemical: string;
        apex: string;
    ...
    traitsDescriptions: {
        ...
        aftermath: string;
        agathion: string;
        agile: string; /** Max speed for number of hexploration activities */
        air: string;
        aiuvarin: string;
        alchemical: string;
        alchemist: string;
