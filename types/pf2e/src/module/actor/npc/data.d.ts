...
import { Abilities, BaseCreatureSource, CreatureAttributes, CreatureDetails, CreatureDetailsSource, CreatureInitiativeSource, CreatureResources, CreatureResourcesSource, CreatureSpeeds, CreatureSystemData, CreatureSystemSource, CreatureTraitsData, CreatureTraitsSource, HeldShieldData, LabeledSpeed, SaveData } from "types/pf2e/src/module/actor/creature/data.ts"
import { ActorAttributesSource, ActorFlagsPF2e, HitPointsStatistic, PerceptionData, StrikeData } from "types/pf2e/src/module/actor/data/base.ts"
import type { ActorSizePF2e } from "types/pf2e/src/module/actor/data/size.ts"
import { InitiativeTraceData } from "types/pf2e/src/module/actor/initiative.ts"
import type { ModifierPF2e, StatisticModifier } from "types/pf2e/src/module/actor/modifiers.ts"
import { ActorAlliance, AttributeString, SaveType } from "types/pf2e/src/module/actor/types.ts"
import type { MeleePF2e } from "types/pf2e/src/module/item/index.ts"
import { PublicationData, Rarity, Size } from "types/pf2e/src/module/data.ts"
