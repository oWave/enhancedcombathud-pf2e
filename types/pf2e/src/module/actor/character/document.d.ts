import { ActorPF2e, CreaturePF2e, type FamiliarPF2e } from "types/pf2e/src/module/actor/index.ts"
import { CreatureSpeeds, LabeledSpeed } from "types/pf2e/src/module/actor/creature/data.ts"
import { CreatureUpdateContext } from "types/pf2e/src/module/actor/creature/types.ts"
import { StrikeData } from "types/pf2e/src/module/actor/data/base.ts"
import { ActorInitiative } from "types/pf2e/src/module/actor/initiative.ts"
import { StatisticModifier } from "types/pf2e/src/module/actor/modifiers.ts"
import { AttributeString, MovementType, RollContext, RollContextParams } from "types/pf2e/src/module/actor/types.ts"
import type { AncestryPF2e, BackgroundPF2e, ClassPF2e, DeityPF2e, FeatPF2e, HeritagePF2e } from "types/pf2e/src/module/item/index.ts"
...
import { UserPF2e } from "types/pf2e/src/module/user/document.ts"
import { TokenDocumentPF2e } from "types/pf2e/src/module/scene/index.ts"
import { RollParameters } from "types/pf2e/src/module/system/rolls.ts"
import { Statistic, StatisticCheck } from "types/pf2e/src/module/system/statistic/index.ts"
