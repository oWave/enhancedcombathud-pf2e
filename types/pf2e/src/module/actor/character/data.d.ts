import { CraftingEntryData } from "types/pf2e/src/module/actor/character/crafting/entry.ts"
import { CraftingFormulaData } from "types/pf2e/src/module/actor/character/crafting/formula.ts"
import { AbilityData, BaseCreatureSource, CreatureAttributes, CreatureDetails, CreatureDetailsSource, CreatureResources, CreatureSystemData, CreatureSystemSource, CreatureTraitsData, HeldShieldData, SaveData, SkillAbbreviation, SkillData } from "types/pf2e/src/module/actor/creature/data.ts"
import { CreatureInitiativeSource, CreatureSpeeds, CreatureTraitsSource, SenseData } from "types/pf2e/src/module/actor/creature/index.ts"
import type { CreatureSensePF2e } from "types/pf2e/src/module/actor/creature/sense.ts"
import { ActorAttributesSource, ActorFlagsPF2e, AttributeBasedTraceData, HitPointsStatistic, InitiativeData, PerceptionData, StrikeData, TraitViewData } from "types/pf2e/src/module/actor/data/base.ts"
import { AttributeString, MovementType, SaveType } from "types/pf2e/src/module/actor/types.ts"
import type { WeaponPF2e } from "types/pf2e/src/module/item/index.ts"
...
import { DeitySystemData } from "types/pf2e/src/module/item/deity/data.ts"
import { DeityDomain } from "types/pf2e/src/module/item/deity/types.ts"
import { BaseWeaponType, WeaponCategory, WeaponGroup } from "types/pf2e/src/module/item/weapon/types.ts"
import { ValueAndMax, ZeroToFour } from "types/pf2e/src/module/data.ts"
import { DamageType } from "types/pf2e/src/module/system/damage/types.ts"
import type { PredicatePF2e } from "types/pf2e/src/module/system/predication.ts"
import type { ArmorClassTraceData, StatisticTraceData } from "types/pf2e/src/module/system/statistic/index.ts"
