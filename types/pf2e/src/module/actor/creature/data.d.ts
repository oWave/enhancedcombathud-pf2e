import { ActorAttributes, ActorDetailsSource, ActorHitPoints, ActorSystemData, ActorSystemSource, ActorTraitsData, ActorTraitsSource, AttributeBasedTraceData, BaseActorSourcePF2e, StrikeData } from "types/pf2e/src/module/actor/data/base.ts"
import type { DamageDicePF2e, ModifierPF2e, RawModifier, StatisticModifier } from "types/pf2e/src/module/actor/modifiers.ts"
import type { ActorAlliance, AttributeString, MovementType, SaveType, SkillAbbreviation, SkillLongForm } from "types/pf2e/src/module/actor/types.ts"
import { LabeledNumber, ValueAndMax, ValuesList, ZeroToThree } from "types/pf2e/src/module/data.ts"
import type { Statistic, StatisticTraceData } from "types/pf2e/src/module/system/statistic/index.ts"
