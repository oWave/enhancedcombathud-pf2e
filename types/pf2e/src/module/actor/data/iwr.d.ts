import { ImmunityType, IWRType, ResistanceType, WeaknessType } from "types/pf2e/src/module/actor/types.ts"
import { IWRException } from "types/pf2e/src/module/rules/rule-element/iwr/base.ts"
import { PredicatePF2e, PredicateStatement } from "types/pf2e/src/module/system/predication.ts"
...
declare class Resistance extends IWR<ResistanceType> implements ResistanceSource {
    protected readonly typeLabels: {
        ...
        spells: string;
        spirit: string;
        "unarmed-attacks": string; /** No value on immunities, so the full label is the same as the application label */
        vitality: string;
        void: string;
        vorpal: string;
