...
import { DexterityModifierCapData } from "types/pf2e/src/module/actor/character/types.ts"
import { Abilities } from "types/pf2e/src/module/actor/creature/data.ts"
import type { ActorSizePF2e } from "types/pf2e/src/module/actor/data/size.ts"
import type { StatisticModifier } from "types/pf2e/src/module/actor/modifiers.ts"
import { ActorAlliance, AttributeString, SkillLongForm } from "types/pf2e/src/module/actor/types.ts"
import type { ConsumablePF2e, MeleePF2e, WeaponPF2e } from "types/pf2e/src/module/item/index.ts"
import { ItemSourcePF2e } from "types/pf2e/src/module/item/base/data/index.ts"
import { MigrationRecord, Rarity, Size, ValueAndMaybeMax, ZeroToTwo } from "types/pf2e/src/module/data.ts"
import { AutoChangeEntry } from "types/pf2e/src/module/rules/rule-element/ae-like.ts"
import { AttackRollParams, DamageRollParams, RollParameters } from "types/pf2e/src/module/system/rolls.ts"
import type { CheckRoll } from "types/pf2e/src/module/system/check/roll.ts"
import type { DamageRoll } from "types/pf2e/src/module/system/damage/roll.ts"
import { StatisticTraceData } from "types/pf2e/src/module/system/statistic/data.ts"
