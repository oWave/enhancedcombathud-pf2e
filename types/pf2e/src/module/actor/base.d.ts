import { ActorAlliance, ActorDimensions, ActorInstances, ApplyDamageParams, AuraData, CheckContext, CheckContextParams, DamageRollContextParams, EmbeddedItemInstances, RollContext, RollContextParams, SaveType } from "types/pf2e/src/module/actor/types.ts"
import { AbstractEffectPF2e, ArmorPF2e, ContainerPF2e, ItemPF2e, PhysicalItemPF2e } from "types/pf2e/src/module/item/index.ts"
import { ItemSourcePF2e, ItemType, PhysicalItemSource } from "types/pf2e/src/module/item/base/data/index.ts"
import { ConditionKey, ConditionSlug, ConditionSource, type ConditionPF2e } from "types/pf2e/src/module/item/condition/index.ts"
import { EffectSource } from "types/pf2e/src/module/item/effect/data.ts"
...
import { AppliedDamageFlag } from "types/pf2e/src/module/chat-message/index.ts"
...
import { RuleElementSynthetics } from "types/pf2e/src/module/rules/index.ts"
import { RuleElementPF2e } from "types/pf2e/src/module/rules/rule-element/base.ts"
import type { UserPF2e } from "types/pf2e/src/module/user/document.ts"
import type { ScenePF2e } from "types/pf2e/src/module/scene/document.ts"
import { TokenDocumentPF2e } from "types/pf2e/src/module/scene/token-document/document.ts"
...
import type { ArmorStatistic, StatisticCheck, StatisticDifficultyClass } from "types/pf2e/src/module/system/statistic/index.ts"
import { EnrichmentOptionsPF2e } from "types/pf2e/src/module/system/text-editor.ts"
