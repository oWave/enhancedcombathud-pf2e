import { ActorAttributes, ActorAttributesSource, ActorDetails, ActorDetailsSource, ActorHitPoints, ActorSystemData, ActorSystemSource, ActorTraitsData, ActorTraitsSource, BaseActorSourcePF2e, BaseHitPointsSource } from "types/pf2e/src/module/actor/data/base.ts"
import { ARMY_TYPES } from "./values.ts";
import { ActorSizePF2e } from "types/pf2e/src/module/actor/data/size.ts"
import { ValueAndMax, ValueAndMaybeMax } from "types/pf2e/src/module/data.ts"
