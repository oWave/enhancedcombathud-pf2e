...
import { DamageDicePF2e, DamageDiceParameters, ModifierAdjustment } from "types/pf2e/src/module/actor/modifiers.ts"
import { ResistanceType } from "types/pf2e/src/module/actor/types.ts"
import type { ArmorPF2e, PhysicalItemPF2e, WeaponPF2e } from "types/pf2e/src/module/item/index.ts"
import { ArmorPropertyRuneType, ResilientRuneType } from "types/pf2e/src/module/item/armor/types.ts"
import { SpellTrait } from "types/pf2e/src/module/item/spell/types.ts"
import { StrikingRuneType, WeaponPropertyRuneType } from "types/pf2e/src/module/item/weapon/types.ts"
import { OneToFour, Rarity, ZeroToFour, ZeroToThree } from "types/pf2e/src/module/data.ts"
import { RollNoteSource } from "types/pf2e/src/module/notes.ts"
import { StrikeAdjustment } from "types/pf2e/src/module/rules/synthetics.ts"
