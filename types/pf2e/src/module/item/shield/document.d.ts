...
import { type WeaponPF2e } from "src/module/item/index.ts";
import { ItemSummaryData } from "src/module/item/base/data/index.ts";
import { PhysicalItemPF2e } from "src/module/item/physical/index.ts";
import { UserPF2e } from "src/module/user/document.ts";
