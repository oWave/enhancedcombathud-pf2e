...
import type { ItemPF2e } from "src/module/item/index.ts";
import { Rarity } from "src/module/data.ts";
import { RuleElementSource } from "src/module/rules/index.ts";
import { SheetOptions, TraitTagifyEntry } from "src/module/sheet/helpers.ts";
