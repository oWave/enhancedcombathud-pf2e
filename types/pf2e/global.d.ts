...
import type { AutomaticBonusProgression } from "src/module/actor/character/automatic-bonus-progression.ts";
import type { ElementalBlast } from "src/module/actor/character/elemental-blast.ts";
import type { FeatGroupOptions } from "src/module/actor/character/feats.ts";
import type { CheckModifier, ModifierPF2e, ModifierType, StatisticModifier } from "src/module/actor/modifiers.ts";
import type { ItemPF2e, PhysicalItemPF2e } from "src/module/item/index.ts";
import type { ConditionSource } from "src/module/item/condition/data.ts";
import type { CoinsPF2e } from "src/module/item/physical/helpers.ts";
import type { ActiveEffectPF2e } from "src/module/active-effect.ts";
import type { CompendiumBrowser, CompendiumBrowserSettings, CompendiumBrowserSources } from "src/module/apps/compendium-browser/index.ts";
import type { EffectsPanel } from "src/module/apps/effects-panel.ts";
import type { HotbarPF2e } from "src/module/apps/hotbar.ts";
import type { LicenseViewer } from "src/module/apps/license-viewer/app.ts";
import type { ActorDirectoryPF2e, ChatLogPF2e, CompendiumDirectoryPF2e, EncounterTrackerPF2e } from "src/module/apps/sidebar/index.ts";
import type { WorldClock } from "src/module/apps/world-clock/app.ts";
import type { CanvasPF2e, EffectsCanvasGroupPF2e } from "src/module/canvas/index.ts";
import type { StatusEffects } from "src/module/canvas/status-effects.ts";
import type { ChatMessagePF2e } from "src/module/chat-message/index.ts";
import type { ActorsPF2e } from "src/module/collection/actors.ts";
import type { CombatantPF2e, EncounterPF2e } from "src/module/encounter/index.ts";
import type { MacroPF2e } from "src/module/macro.ts";
import type { RuleElementPF2e, RuleElements } from "src/module/rules/index.ts";
import type { UserPF2e } from "src/module/user/index.ts";
import type { AmbientLightDocumentPF2e, MeasuredTemplateDocumentPF2e, ScenePF2e, TileDocumentPF2e, TokenDocumentPF2e } from "src/module/scene/index.ts";
import type { ActorDeltaPF2e } from "src/module/scene/token-document/actor-delta.ts";
import type { PF2ECONFIG, StatusEffectIconTheme } from "src/scripts/config/index.ts";
import type { DicePF2e } from "src/scripts/dice.ts";
import type { calculateXP, checkPrompt, editPersistent, launchTravelSheet, perceptionForSelected, rollActionMacro, rollItemMacro, stealthForSelected, xpFromEncounter } from "src/scripts/macros/index.ts";
import type { remigrate } from "src/scripts/system/remigrate.ts";
import type { CheckPF2e } from "src/module/system/check/index.ts";
import type { ConditionManager } from "src/module/system/conditions/manager.ts";
import type { EffectTracker } from "src/module/system/effect-tracker.ts";
import type { ModuleArt } from "src/module/system/module-art.ts";
import type { CustomDamageData, HomebrewTag, HomebrewTraitSettingsKey } from "src/module/system/settings/homebrew/index.ts";
import type { TextEditorPF2e } from "src/module/system/text-editor.ts";
import type { sluggify } from "src/util/index.ts";
